...
public class HomeController {
    ...
    public static void providerData() {
        ...
        try {
            ...
            Object obj = jsonParser
                    .parse(new FileReader("d:\\project2\\hello-spring\\src\\main\\resources\\static\\providers.json"));

            JSONArray jsonArr = (JSONArray) obj;

            for (int i = 0; i < jsonArr.size(); i++) {
                JSONObject provider_url = (JSONObject) jsonArr.get(i);
                // String key = (String) provider_url.get("provider_url");
    ...
    public String oembedResponse(@RequestParam("userUrlData") String userUrlData)
        ...
        try {
            ...
            // MAP 사용할까 하다 말았다,
            // 예제 보니까 알파벳 순으로 정렬이 아니라서, 하나하나 정렬하려고
